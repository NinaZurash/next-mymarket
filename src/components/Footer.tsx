...
export default function Footer() {
  ...
  return (
    <div className="flex w-[100vw] justify-between border-t border-t-slate-200 px-52 py-20">
      {Object.entries(FOOTER_INFO).map(([key, data]) => (
        <div key={key} className="flex flex-col gap-5">
          <span className="flex font-semibold">{key}</span>
          <ul className="flex flex-col gap-5">
            {data.map((item) => (
              <li
                className="font-sans text-sm text-[#b5b5b5] hover:cursor-pointer hover:text-gray-700"
                key={item}
              >
                {item}
              </li>
            ...
            {key === "დახმარება" ? (
              <div className="flex gap-4">
                <svg
                  className="h-8 w-8 rounded-full bg-slate-100 p-2 transition-all duration-300 ease-in-out hover:cursor-pointer hover:bg-slate-400 "
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_6196_17198)">
                    <path
                  ...
                  <defs>
                    <clipPath id="clip0_6196_17198">
                      <rect width="8" height="17" fill="white" transform="translate(0 0.5)"></rect>
                    </clipPath>
                  </defs>
                </svg>
                <svg
